...
import { Shield, Globe, Bot, ArrowRight, Zap, Lock, Coins, Sparkles, Database, Code, Brain } from 'lucide-react';
import logo from '@/assets/logo.png';
import { ReactNode } from 'react'; // Added generic React import if needed for types
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex items-center gap-3">
                            <img src={logo.src} alt="ScrapeSafe" className="h-8 w-auto" />
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <Link href="/market" className="text-muted-foreground hover:text-primary transition-colors">Marketplace</Link>
                            <Link href="/bot" className="text-muted-foreground hover:text-primary transition-colors">Simulator</Link>
                        </div>
