...
import { Globe, FileText, Plus, Bot, Brain, Wallet, Shield, Layers } from 'lucide-react';
...
const EmptyState = ({
    ...
    <div className={`rounded-2xl border-2 border-dashed p-12 text-center ${variant === 'cyan' ? 'border-primary/20 bg-primary/5' : 'border-accent/20 bg-accent/5'
        }`}>
        <div className={`inline-flex p-4 rounded-xl mb-4 ${variant === 'cyan' ? 'bg-primary/10' : 'bg-accent/10'
            }`}>
...
const AssetCard = ({
    ...
    return (
        <div className="card-cyber rounded-xl bg-card border border-border overflow-hidden">
            ...
            <div className={`h-2 ${hasActiveLicense
